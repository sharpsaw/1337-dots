...
# Overlays with: /etc/xdg/subtle/subtle.rb
#
...
9.times do |e| grab "C-#{e}", "ViewSwitch#{e}".to_sym end
...
%w(term www chat voip mail default).map{|e| view e, e}
